...
document.addEventListener("DOMContentLoaded", function () {
    ...
    numpad.attach({
        target: "express_post_quantity_input",
        max: 3, // 3 DIGITS MAX
        decimal: false
    });
    ...
    create_printer_dropdown("bulk_express_label_printer_select", "post")


    express_post_label_btn = document.getElementById("express_post_label_btn")
    express_post_label_btn.onclick = function () {
        $('#express_post_Modal').modal('show')
    }
    ...
    modalExpressPostCancel = document.getElementById("cancel_express_post_modal")
    modalExpressPostCancel.onclick = function () {
        $('#express_post_Modal').modal('hide')
    }


    print_express_post_submit = document.getElementById("print_express_post_submit")
    print_express_post_submit.onclick = function () {
        var express_post_config = document.getElementById("express_post_config_input")
        var express_post_height = document.getElementById("express_post_height_input")
        var express_post_finish_option = document.getElementById("express_post_finish_option_input")
        var express_post_quantity = document.getElementById("express_post_quantity_input")
        var bulk_express_label_printer_select = document.getElementById("bulk_express_label_printer_select")

        var express_json = {
            "config": express_post_config.value,
            "height": express_post_height.value,
            "finish_option": express_post_finish_option.value,
    ...
    socket.on("fromBulkPrintExpressPost", function (message, successBool) {
